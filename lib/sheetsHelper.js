...
async function readAllRows(spreadsheetId, sheetTitle, lastCol) {
  ...
  const res = await sheets.spreadsheets.values.get({
    ...
    // Filas escritas antes de la migración pueden tener columnas de fecha/hora como
    // valores reales de Sheets (no texto); con UNFORMATTED_VALUE llegan como número
    // serial en vez de texto ya formateado al locale de la hoja (ej. "9/06/2026").
    // También evita que números grandes lleguen con separador de miles como texto.
